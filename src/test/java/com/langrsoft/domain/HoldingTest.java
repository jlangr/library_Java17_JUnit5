...
class HoldingTest {
    ...
    static final Date TOMORROW = new Date(TODAY.getTime() + 60L + 60 * 1000 * 24);
    ...
    @Test
    void checkOutAndCheckInFlowToday() {
        holding.checkOut(TODAY);
        assertThat(holding.dateCheckedOut()).isEqualTo(TODAY);
    }
    @Test
    void checkOutAndCheckInFlowTodayDateDue() {
        holding.checkOut(TODAY);
        assertThat(holding.dateDue()).isAfter(TODAY);
    }
    @Test
    void checkOutAndCheckInFlowValidateBranch() {
        holding.checkOut(TODAY);
        assertThat(holding.getBranch()).isEqualTo(Branch.CHECKED_OUT);
    }
    @Test
    void checkOutAndCheckInFlowStockAvailable() {
        holding.checkOut(TODAY);
    ...
    @Test
    void checkOutAndCheckInFlowTomorrow() {
    ...
    @Test
    void checkOutAndCheckInFlowTomorrowIsAvailable() {
    ...
    @Test
    void checkOutAndCheckInFlowTomorrowValidateBranch() {
